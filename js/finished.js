...
(function() {
  ...
  window.onload = function() {
    ...
    d3.csv("./data/dataEveryYear.csv")
      ...
      //ADD DISTINCT YEARS CODE FROM MIN
      ...
      .append('circle')
        ...
        .on("mouseover", (d) => {
          ...
          div//.html(d.location + "<br/>" + numberWithCommas(d["pop_mlns"]*1000000))
            ...
            .append(makeScatterPlot(d["location"]));
        })
        .on("mouseout", (d) => {
          div.transition()
            .duration(500)
  ...
  function makeLineGraph(country) {
    ...
    let funcs = drawAxes(minMax, "time", "life_expectancy", svgLineGraph, {min: 50, max: 250}, {min: 50, max: 250});
